/*
Ordering of insert operations matters
Parent tables must be populated before child tables that reference them
Foreign key constraints help understand table dependencies and ordering
*/

SELECT '=== Loading company_dim Table ===' AS info;
INSERT INTO company_dim (company_id, name)
SELECT company_id, name
FROM read_csv('https://storage.googleapis.com/sql_de/company_dim.csv'); -- How awesome is DuckDB?
